    ...
    public class E_EnableAddons : EditorWindow
    {
        ...
        private static void CB_AddonShooter(bool e_disable_shooter = false)
        {
                       ...
                       "Continue", "Cancel"))
            {
                ...
                modifications.Add(new E_Helpers.CB_Additions(
                    in_target: "private bool _ignoreIKFromAnimator;",
                    in_add: "protected bool _ignoreIKFromAnimator;",
                    in_nextline: "",
                    in_type: E_Helpers.CB_FileAddtionType.Replace
                ));
        ...
        private static void CB_AddonSwimming(bool e_disable_swimming = false)
        {
                        ...
                        "Continue", "Cancel"))
            {
                ...
                try
                {
                    modifications.Clear();
                    modifications.Add(new E_Helpers.CB_Additions(
                        in_target: "private bool inTheWater;",
                        in_add: "protected bool inTheWater;",
                        in_nextline: "",
                        in_type: E_Helpers.CB_FileAddtionType.Replace
                    ));
                    E_Helpers.ModifyFile(@"Assets/Invector-3rdPersonController/Add-ons/Swimming/Scripts/vSwimming.cs", modifications);
                    Debug.Log("Modified file at: Assets/Invector-3rdPersonController/Add-ons/Swimming/Scripts/vSwimming.cs");
                }
                catch
                {
                    Debug.LogError("Failed to modify file at: Assets/Invector-3rdPersonController/Add-ons/Swimming/Scripts/vSwimming.cs");
                }
                #endregion
