...
namespace CBGames.Editors
{
    public class E_ModifyInvector : EditorWindow
    {
        ...
        public static void CB_ModifyInvectorFiles(bool disable_files = false)
        {
            ...
            #region vSaveLoadInventory
            try
            {
                modifications.Clear();
                modifications.Add(new E_Helpers.CB_Additions(
                    in_target: "public static void LoadInventory(this vItemManager itemManager)",
                    in_add: "public static void LoadInventory(this vItemManager itemManager, string jsonData = null)",
                    in_nextline: "",
                    in_type: E_Helpers.CB_FileAddtionType.Replace
                ));
                modifications.Add(new E_Helpers.CB_Additions(
                    in_target: "string json = LoadInventoryJasonText();",
                    in_add: "string json = (string.IsNullOrEmpty(jsonData)) ? LoadInventoryJasonText() : jsonData;",
                    in_nextline: "",
                    in_type: E_Helpers.CB_FileAddtionType.Replace
                ));
                E_Helpers.ModifyFile(@"Assets/Invector-3rdPersonController/ItemManager/Scripts/Examples/vSaveLoadInventory.cs", modifications);
                Debug.Log("Modified file at: Assets/Invector-3rdPersonController/ItemManager/Scripts/Examples/vSaveLoadInventory.cs");

                E_Helpers.CommentOutRegionInFile("InvectorMultiplayer/Scripts/Core/NetworkManager.cs", "InvectorModification", disable_files);
            }
            catch
            {
                Debug.Log("Failed to modify file at: Assets/Invector-3rdPersonController/ItemManager/Scripts/Examples/vSaveLoadInventory.cs");
            }
            #endregion
            ...
            try
            {
                modifications.Clear();
                modifications.Add(new E_Helpers.CB_Additions(
                    in_target: "void ExitLadderInput()",
                    in_add: "protected virtual void ExitLadderInput()",
                    in_nextline: "",
                    in_type: E_Helpers.CB_FileAddtionType.Replace
                ));
                modifications.Add(new E_Helpers.CB_Additions(
                    in_target: "void TriggerEnterLadder()",
                    in_add: "protected virtual void TriggerEnterLadder()",
                    in_nextline: "",
                    in_type: E_Helpers.CB_FileAddtionType.Replace
                ));
                E_Helpers.ModifyFile(@"Assets/Invector-3rdPersonController/Basic Locomotion/Scripts/CharacterController/Actions/vLadderAction.cs", modifications);
                Debug.Log("Modified file at: Assets/Invector-3rdPersonController/Basic Locomotion/Scripts/CharacterController/Actions/vLadderAction.cs");
            }
            catch
            {
                Debug.Log("Failed to modify file at: Assets/Invector-3rdPersonController/Basic Locomotion/Scripts/CharacterController/Actions/vLadderAction.cs");
            }

            try
            {
                E_Helpers.CommentOutRegionInFile("InvectorMultiplayer/Editor/Scripts/Windows/ConvertPlayer/E_CoreConvertPlayer.cs", "LadderAction", disable_files);
                results = E_Helpers.CommentOutFile("InvectorMultiplayer/Scripts/Player/Basic/MP_vLadderAction.cs", disable_files);
                Debug.Log(results);
            }
            catch
            {
                Debug.Log("Failed to uncomment file at: Assets/InvectorMultiplayer/Scripts/Player/Basic/MP_vLadderAction.cs");
            }
            #endregion
